...
open class ProductRecord() : UpdatableRecordImpl<ProductRecord>(Product.PRODUCT), Record10<Long?, String?, String?, String?, BigDecimal?, BigDecimal?, BigDecimal?, ByteArray?, LocalDateTime?, LocalDateTime?> {
    ...
    override fun valuesRow(): Row10<Long?, String?, String?, String?, BigDecimal?, BigDecimal?, BigDecimal?, ByteArray?, LocalDateTime?, LocalDateTime?> = super.valuesRow() as Row10<Long?, String?, String?, String?, BigDecimal?, BigDecimal?, BigDecimal?, ByteArray?, LocalDateTime?, LocalDateTime?>
    ...
    override fun field8(): Field<ByteArray?> = Product.PRODUCT.IMAGE
    override fun field9(): Field<LocalDateTime?> = Product.PRODUCT.CREATION_TIMESTAMP
    override fun field10(): Field<LocalDateTime?> = Product.PRODUCT.MODIFICATION_TIMESTAMP
    ...
    override fun component8(): ByteArray? = image
    override fun component9(): LocalDateTime? = creationTimestamp
    override fun component10(): LocalDateTime? = modificationTimestamp
    ...
    override fun value8(): ByteArray? = image
    override fun value9(): LocalDateTime? = creationTimestamp
    override fun value10(): LocalDateTime? = modificationTimestamp
    ...
    override fun value8(value: ByteArray?): ProductRecord {
        this.image = value
        return this
    }
    ...
    override fun value10(value: LocalDateTime?): ProductRecord {
        this.modificationTimestamp = value
        return this
    }

    override fun values(value1: Long?, value2: String?, value3: String?, value4: String?, value5: BigDecimal?, value6: BigDecimal?, value7: BigDecimal?, value8: ByteArray?, value9: LocalDateTime?, value10: LocalDateTime?): ProductRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long? = null, name: String? = null, description: String? = null, categoryId: String? = null, salePrice: BigDecimal? = null, promotionalPrice: BigDecimal? = null, quantity: BigDecimal? = null, image: ByteArray? = null, creationTimestamp: LocalDateTime? = null, modificationTimestamp: LocalDateTime? = null): this() {
        this.id = id
        this.name = name
